    ...
    return (
        <div className="group relative flex flex-col w-full h-full">
            ...
            <div className="relative aspect-video bg-gray-900 rounded-xl border-[6px] border-gray-800 shadow-2xl overflow-hidden ring-1 ring-white/10">
                ...
                {/* Screen */}
                <div className="w-full h-full pt-7 bg-gray-950 overflow-hidden">
                    <img
                        src={screenshotUrl}
                        alt={title}
            ...
            <div className="mt-8 flex flex-col gap-4 px-2">
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        {/* <h6 className="text-sm text-yellow-500">{status}</h6> */}
                        ...
                        {repoUrl && (
                            <a
                                ...
                                className="w-8 h-8 bg-black/50 backdrop-blur-md border border-white/20 text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 hover:bg-white hover:text-black transition-all duration-300"
                            >
