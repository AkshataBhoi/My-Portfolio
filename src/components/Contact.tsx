                ...
                <div className="max-w-4xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center bg-main-bg/50 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl shadow-black/20">
                        ...
                        <div className="text-left">
                            ...
                            <motion.p
                                className="text-text-secondary text-lg mb-8 leading-relaxed hidden md:block"
                                initial={{ opacity: 0, y: 20 }}
                                whileInView={{ opacity: 1, y: 0 }}
                                viewport={{ once: true }}
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="flex items-center gap-4 text-text-secondary bg-white/5 p-4 rounded-2xl border border-white/5">
