                ...
                <div className="max-w-4xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center bg-main-bg/50 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl shadow-black/20">
                        ...
                        <div className="text-left">
                            <motion.h2
                                className="text-3xl md:text-3xl font-bold mb-6 text-text-primary"
                            ...
                            <motion.p
                                className="text-text-secondary text-md mb-8 leading-relaxed hidden md:block"
                                initial={{ opacity: 0, y: 20 }}
                                whileInView={{ opacity: 1, y: 0 }}
                                viewport={{ once: true }}
                            ...
                            <div className="grid grid-cols-1 gap-2  ">
                                <div className="  flex items-center gap-4 text-text-secondary bg-white/5 p-2 rounded-2xl border border-white/5">
                                    <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-violet-500 shrink-0">
                                        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                        </svg>
                                    </div>
                                    <span className="text-sm break-all">akshatabbhoi@gmail.com</span>
                                </div>
                                <div className="flex items-center gap-4 text-text-secondary bg-white/5 p-2 rounded-2xl border border-white/5">
                                    <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-blue-500 shrink-0">
                                        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
